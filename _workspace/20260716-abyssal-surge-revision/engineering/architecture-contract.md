...
5. **[VERIFIED] The deployed product is a static GitHub Pages client.** The live configured playable URL is `https://jellyggumi.github.io/Abyssal-Command/`. The requested `https://jellyggumi.github.io/Abyssal-Surge/` currently redirects to a journal, so it is not an approved game endpoint (`intake/production-brief.md:7-10`).
