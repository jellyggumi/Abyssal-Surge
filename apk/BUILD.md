# Abyssal Command — TWA (APK) Build Kit
...
mkdir abyssal-command-twa && cd abyssal-command-twa
...
it (packageId `io.github.jellyggumi.abyssalsurge`, name "Abyssal Command", theme
