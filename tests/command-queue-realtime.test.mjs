...
async function loadAppQueueRuntime({ campaign = campaignAtStageOne(), includeFallback = false } = {}) {
  ...
  const context = vm.createContext({
    ...
    commandTutorialSignal: { cameraMoved: false, hasSelection: false },
    COMMAND_TUTORIAL_STORAGE_KEY: "abyssal-command-camera-tutorial-v1",
    COMMAND_TUTORIAL_REPEAT_MS: 6000,
    COMMAND_TUTORIAL_MAX_REPEATS: 8,
    translate: (key) => key,
